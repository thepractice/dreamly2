...
#	}
	...
	#		end		
		...
		def set_rating
			# Create initial like and ranking
			self.liked_by self.user
			rating = update_rating(self)
			self.update_columns(rating: rating) 			
		end
